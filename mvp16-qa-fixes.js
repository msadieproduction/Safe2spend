function installQaFixes(w,d){
 if(d.documentElement.dataset.s2sQaReady==='1')return true;
 if(d.getElementById('mvp16QaFixes'))return false;
...
localStorage.setItem(KEY,JSON.stringify(P));document.documentElement.dataset.s2sQaReady='1';
`;d.body.appendChild(patch);
 return d.documentElement.dataset.s2sQaReady==='1';
}
